...
const translations = {
  sv: {
    ...
    "step.give.subtitle": "Passet du ska lämna",
    "step.take.subtitle": "Passet du ska ta istället",
    "step.result.title": "Resultat",
    "step.result.subtitle": "Så mycket skiljer sig lönen",
    "step.swap": "Byt pass",
  ...
  en: {
    ...
    "step.give.subtitle": "The shift you're giving up",
    "step.take.subtitle": "The shift you're taking instead",
    "step.result.title": "Result",
    "step.result.subtitle": "How much pay differs",
    "step.swap": "Swap shifts",
